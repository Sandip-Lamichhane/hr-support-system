...
const Sidebar = ({ sidebarOpen }) => {
    ...
    const menuItems = [
        { path: "/employee/dashboard", icon: Home, label: "Dashboard", end: true },
        { path: "/employee/tickets", icon: Ticket, label: "Tickets" },
        // { path: "/employee/users", icon: Users, label: "Users" },
        {
            label: "Settings",
            icon: Settings,
            children: [
                {
                    path: "/employee/settings/department",
                    icon: Building2,
                    label: "Department",
                },
                {
                    path: "/employee/settings/category",
