        ...
        <div className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50 shadow-sm">
            <div className="flex items-center justify-between h-full px-4">
                ...
                <div className="flex-1 max-w-xl mx-4 hidden md:block">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <DateTimeBlock />
                    <button className="relative p-2 hover:bg-emerald-50 rounded-lg">
                    ...
                    <button className="flex items-center gap-2 p-2 hover:bg-emerald-50 rounded-lg">
                        <div className="w-8 h-8 bg-gradient-to-br from-emerald-300 to-teal-400 rounded-full flex items-center justify-center">
